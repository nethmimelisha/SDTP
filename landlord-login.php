...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, username_or_email, password_hash FROM landlord WHERE username_or_email = ? OR email = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO landlord_reg (name, nic, email, address, phone) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $name, $nic, $email, $address, $phone);
...
<!----------------------------- Form box ----------------------------------->    
    <div class="form-box">
        ...
        <!------------------- login form -------------------------->
        <form action="landlord-login.php" method="post">
        <div class="login-container" id="login">
            <div class="top">
                <span>Don't have an account? <a href="#" onclick="register()">Sign Up</a></span>
                <header>Landlord Login</header>
            </div>
            <div class="input-box">
