...
// Check if the form is submitted for student login
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    $sql = "SELECT id, username_or_email, password_hash FROM student WHERE username_or_email = ? OR email = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO student_reg (student_id, batch, name, email, address, phone) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $studentId, $batch, $name, $email, $address, $phone);
